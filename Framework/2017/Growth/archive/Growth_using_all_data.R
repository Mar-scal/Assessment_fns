...
# Save the resutls so we don't need to keep re-running them.
#save.image(paste(direct,"data/Framework/2017/Growth/BoF_Annual_curves_vs_one_curve_model_results.RData",sep="")
