...
# 7:  dat:      What output file do you want to load.  If the entire survey summary isn't available yet you'll need to load
# 8:  season:   For the spring survey we need to identify that we don't have all the results in yet.  When running the scripts with only spring  
