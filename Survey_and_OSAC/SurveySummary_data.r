...
for(i in 1:num.surveys)
{
  ...
  if((bnk == "Ger" || bnk == "Mid" || bnk=="Ban") && yr.start < 1985) years <- 1985:yr
  ...
  if(bnk == "BBn")  bank.dat[[bnk]]$tow[ bank.dat[[bnk]]$year %in% 1991:2008] <-bank.dat[[bnk]]$tow[bank.dat[[bnk]]$year %in% 1991:2008]+200
