...
if(params$bank %in% c("Ger", "GB", "GBa", "GBb")) cftsltm <- "The horizontal dashed lines are the long term medians for each time series. "

cftsgb <- NULL
if(params$bank %in% c("GBa", "GBb", "GB")) cftsgb <- "The May and August results are shown separately. "
