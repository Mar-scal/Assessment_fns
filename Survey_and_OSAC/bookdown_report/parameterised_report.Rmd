...
```{r, echo=FALSE, message=F, out.height="80%", out.width="80%", fig.align="center", fig.cap=paste0("Abundance time series, represented by number of scallop per standardized tow (y-axis). Pre-recruits are shown in the top panel, recruit-sized scallop in the middle panel, and fully-recruited scallop are in the bottom panel. The grey dashed line is the long term median.")}
...
```{r, echo=FALSE, message=F, out.height="80%", out.width="80%", fig.align="center", fig.cap=paste0("Biomass time series, represented by kilograms (kg) of scallop per standardized tow (y-axis). Pre-recruits are shown in the top panel, recruit-sized scallop in the middle panel, and fully-recruited scallop are in the bottom panel. The grey dashed line is the long term median.")}
...
```{r, echo=FALSE, message=F, out.height="80%", out.width="80%", fig.align="center", fig.cap="Clapper time series, represented by percentage of clappers per tow."}
