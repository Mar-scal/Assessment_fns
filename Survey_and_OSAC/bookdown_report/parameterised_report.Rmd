...
Pre-recruits (Figure `r params$banknum * 6`)
 - 75% of the `r year` survey tows had `r prthisyear` pre-recruits per tow
 - The tow with the most pre-recruits had `r highlights$thisyear[highlights$variable=="maxPRtow" & highlights$bank==params$bank]` individuals

Recruits (Figure `r params$banknum * 7`)
 -75% of the `r year` survey tows had `r rthisyear` recruits per tow
 - The tow with the most recruits had `r highlights$thisyear[highlights$variable=="maxRtow" & highlights$bank==params$bank]` individuals
 
Fully-recruited scallop (Figure `r params$banknum * 8`)
 - 75% of the `r year` survey tows had `r frthisyear` fully-recruited scallop per tow
 - The tow with the most fully-recruited scallop had `r highlights$thisyear[highlights$variable=="maxCtow" & highlights$bank==params$bank]` individuals

Condition factor (Figure `r params$banknum * 9`)
 - Between `r highlights$thisyear[highlights$variable=="minCF" & highlights$bank==params$bank]` and `r highlights$thisyear[highlights$variable=="maxCF" & highlights$bank==params$bank]` in `r year`
...
Meat count  (Figure `r params$banknum * 10`)
 ...
 - Ranging from `r highlights$thisyear[highlights$variable=="minMC" & highlights$bank==params$bank]` to `r highlights$thisyear[highlights$variable=="maxMC" & highlights$bank==params$bank]`
