...
In the `r bankname` survey, pre-recruits are considered to be scallops with shell heights less than `r sizes$RS[sizes$bank==params$bank]$size` mm, recruits have shell heights from `r sizes$RS[sizes$bank==params$bank]$size` mm to `r sizes$CS[sizes$bank==params$bank]$size` mm, and fully-recruited scallop have shell heights greater than `r sizes$CS[sizes$bank==params$bank]$size` mm. Recruits are expected to grow to commercial size in the next year. All long term medians calculated in this analysis exclude the current year's survey results. 

```{r, echo=F, message=F, out.height="100%", out.width="100%", fig.align="center", fig.cap=paste0("Survey station map. There were ", sum(ntows$Freq[ntows$bank==params$bank]), " tow locations.")}
...
The spatial distribution of pre-recruits, recruits, and fully-recruited scallop are shown in Figures `r params$banknum * 6` - `r params$banknum * 8`, and statistical summaries are in Table `r tabnum[3]`.
...
```{r, echo=FALSE, message=F, out.height="100%", out.width="100%", fig.align="center", fig.cap="Spatial distribution of pre-recruit scallop. Each point is a survey station, and the colour shows the distribution of abundance based on an INLA model."}
...
```{r, echo=FALSE, message=F, out.height="100%", out.width="100%", fig.align="center", fig.cap="Spatial distribution of recruit scallop. Each point is a survey station, and the colour shows the distribution of abundance based on an INLA model."}
...
```{r, echo=FALSE, message=F, out.height="100%", out.width="100%", fig.align="center", fig.cap="Spatial distribution of fully-recruited scallop. Each point is a survey station, and the colour shows the distribution of abundance based on an INLA model."}
...
```{r, echo=FALSE, message=F, out.height="100%", out.width="100%", fig.align="center", fig.cap="Spatial distribution of scallop condition."}
...
```{r, echo=FALSE, message=F, out.height="100%", out.width="100%", fig.align="center", fig.cap="Spatial distribution of meat weight."}
