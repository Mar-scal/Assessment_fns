...
- [Survey design](#`r paste0(params$bank, "SD")`)  
...
[Return to links](#`r paste0(params$bank, "links")`)
\newpage
...
```{r, echo=FALSE, message=F, out.height="70%", out.width="70%", fig.align="center", fig.cap="Spatial distribution of pre-recruit scallop. Each point is a survey station, and the colour shows the distribution of abundance based on an INLA model."}
...
```{r, echo=FALSE, message=F, out.height="70%", out.width="70%", fig.align="center", fig.cap="Spatial distribution of recruit scallop. Each point is a survey station, and the colour shows the distribution of abundance based on an INLA model."}
...
```{r, echo=FALSE, message=F, out.height="70%", out.width="70%", fig.align="center", fig.cap="Spatial distribution of fully-recruited scallop. Each point is a survey station, and the colour shows the distribution of abundance based on an INLA model."}
...
```{r, echo=FALSE, message=F, out.height="70%", out.width="70%", fig.align="center", fig.cap="Spatial distribution of scallop condition."}
...
```{r, echo=FALSE, message=F, out.height="70%", out.width="70%", fig.align="center", fig.cap="Spatial distribution of meat weight."}
