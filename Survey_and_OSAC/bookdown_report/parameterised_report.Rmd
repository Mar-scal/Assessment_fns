...
knitr::kable(table, format = "latex", row.names=F, booktabs=T, caption="The size range (in millimetres, mm) of 75% of the scallops caught in each size class for the current survey and previous survey.") %>%
  kableExtra::kable_styling(latex_options = "HOLD_position")
