...
cftsltm <- "The dashed line is the long term median."
if(params$bank %in% c("Ger", "GB", "GBa", "GBb")) cftsltm <- "The dashed lines are the long term medians for each time series. "
