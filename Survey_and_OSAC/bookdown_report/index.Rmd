...
The spring offshore scallop survey occurred from `r min(dates$start)` to `r max(dates$end)` on Middle Bank, Sable Bank, German Bank, and Browns Bank North, Browns Bank South, and the Georges Bank monitoring stations. The Chief Scientist was Tricia Pearo Drew, and the survey was carried out on the Fundy Leader.
