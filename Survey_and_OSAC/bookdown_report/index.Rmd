...
We also compare values from the current survey to the most recent previous survey, and/or to long term medians. In this report, all long term medians exclude the value from the current year. For this 2021 survey, results are compared to the 2019 survey results since the full assessment survey did not occur in 2020.
