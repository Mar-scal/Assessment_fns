...
header-includes:
 ...
 - \usepackage{fancyhdr}
 - \pagestyle{fancy}
 - \fancyfoot[CO,CE]{Summer Survey 2024}
...
The Summer Offshore Scallop Survey occurred from August 8 to 19, 2024 on Georges Bank 'a' and 'b'. The Chief Scientist was Tricia Pearo Drew, and the survey was carried out on the Fundy Leader.
...
Calculation methods approved during the February 2024 Data Inputs Framework for SFA 27B are being implemented in this document and will be used from now on.
