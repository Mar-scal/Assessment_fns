...
The Summer Offshore Scallop Survey occurred from `r stamp("March 1")(min(dates$start)-days(1))` to `r stamp("March 1, 2021")(max(dates$end) + days(1))` on Georges Bank 'a' and 'b'. The Chief Scientist was Tricia Pearo Drew, and the survey was carried out on the Fundy Leader.
