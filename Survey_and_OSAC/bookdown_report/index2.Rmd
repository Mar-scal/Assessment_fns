...
header-includes:
 ...
 - \usepackage{fancyhdr}
 - \pagestyle{fancy}
 - \fancyfoot[CO,CE]{Summer Survey 2023}
...
The Summer Offshore Scallop Survey occurred from August 16 to 26, 2023 on Georges Bank 'a' and 'b'. The Chief Scientist was Tricia Pearo Drew, and the survey was carried out on the Fundy Leader.
...
We also compare values from the current survey to the most recent previous survey, and/or to long term medians. In this report, all long term medians exclude the value from the current year, and percent change is calculated relative to the previous survey’s value.
