...
require(lubridate)
load(paste0(direct_fns,"Survey_and_OSAC/bookdown_report/summary_both_2023.Rdata"))
...
The Offshore Scallop Surveys in `r year` occurred on Middle Bank, Sable Bank, German Bank, Browns Bank North, and Browns Bank South in the Spring, and Georges Bank 'a' and Georges Bank 'b' in the Summer. The Chief Scientist was Tricia Pearo Drew, and the surveys were carried out on the Fundy Leader.
...
We also compare values from the current survey to the most recent previous survey, and/or to long term
medians. In this report, all long term medians exclude the value from the current year, and percent change is
calculated relative to the previous survey’s value.
