...
header-includes:
 ...
 - \usepackage{fancyhdr}
 - \pagestyle{fancy}
 - \fancyfoot[CO,CE]{Spring & Summer Surveys 2021}
...
The Offshore Scallop Surveys in `r year` occurred on Middle Bank, Sable Bank, German Bank, Browns Bank North, Browns Bank South, and the Georges Bank monitoring stations in the Spring, and Georges Bank 'a' and Georges Bank 'b' in the Summer. The Chief Scientist was Tricia Pearo Drew, and the survey was carried out on the Fundy Leader.
