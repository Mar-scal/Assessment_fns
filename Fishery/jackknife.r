...
####
# Fall 2015:  I can't remember when, but DK updated this to allow for only the correct variance estimator to be 
# calculated for the data.  It results in a variance that is far too small but it is the correct value.
################################################################################################################
