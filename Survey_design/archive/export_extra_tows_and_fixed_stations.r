...
# Combine them all
extra.stations <- rbind(GB.extra,BBn.spring,GBa,GBb)
...
#write.csv(extra.stations,paste(direct,"Data/Survey_data/Survey_design/Extra_stations.csv",sep=""),row.names=F)
