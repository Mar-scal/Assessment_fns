...
otherbanks <- function(mwger_0, shfger_0, bank, direct){
  ...
  png(paste0(direct, "2019/Presentations/Special_industry_presentations/German Condition/", bank, "/SHF_gear_detailed_mwger_0_GBa_protocol.png"), width = 13,height = 8.75,res=420, units="in")
  ggplot() + geom_histogram(data=mwger_0, aes(sh), binwidth=5) + facet_wrap(~protocol, nrow=2) +
    theme_bw() + 
    theme(panel.grid=element_blank()) +
    scale_x_continuous(limits = c(0,200), breaks=seq(0,200, 10), labels=seq(0,200,10), expand=c(0,0)) +
    ylab("Frequency")
  ...
  png(paste0(direct, "2019/Presentations/Special_industry_presentations/German Condition/", bank, "/SHF_gear_general_shfger_0_GBa_protocol.png"), width = 13,height = 8.75,res=420, units="in")
  ggplot() + geom_histogram(data=shfger_0_melt, aes(sh, value), stat="identity", binwidth=5) + facet_wrap(~protocol, nrow=2) +
    theme_bw() + 
    theme(panel.grid=element_blank())+
