...
bank <- "BBs"
year <- 2023 # this is for the folder save location
survey_years <- 2021 # choose one year only (most recent will contain past years)
fishery_years <- 2021:2022 # choose multiple years
station_years <- 2023
seeds=54880:54884
