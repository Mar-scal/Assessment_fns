...
write.csv(dplyr::select(stations2020, bank, tow2020, lat, lon, sampled, pastyear, pasttow), file = "C:/Users/keyserf/Documents/Version_control_pandemic/Offshore/Survey/2020/GB_stations2020_proposed.csv")
```
...
write.csv(dplyr::select(BBn_tows, bank, tow2020, lat, lon, pastyear, pasttow), file = "C:/Users/keyserf/Documents/Version_control_pandemic/Offshore/Survey/2020/BBn_stations2020_proposed.csv")
```
