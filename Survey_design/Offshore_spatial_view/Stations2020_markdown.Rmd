...
I used a buffering approach for GB that might be helpful if you don't want to pick by eye (line 113-ish)
...
# pick some extra tows from 2019 (20 more are needed!) and add them to the add_ons vector below using their ID (NOT tow number).
...
BBn_tows <- BBn_tows %>%
  filter(!ID == "2019.223") %>% # I took out this one since it was so far south...
  st_as_sf(coords=c("lon", "lat"), remove=F, crs=4326)

BBn_tows$tow2020 <- 201:230 # this will be 201:250 eventually
