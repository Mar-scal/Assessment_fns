...
sc <- getURL("https://raw.githubusercontent.com/Mar-scal/Assessment_fns/master/Survey_design/Survey_design_sf.R",ssl.verifypeer = FALSE)
eval(parse(text = sc))
...
textInput("direct",label = "Data Directory",value = "github")
textInput("repo",label = "Repo",value = 'github')
sliderInput("text.size","Adjust text size", value = 1,min=0.5,max=10,step=0.5)
