...
getSpringSurveyData2011<-function(direct="Y:/Offshore scallop/Assessment/")
{
...
#DK Note August 19 2015 Load the necessary functions, an idea for later might be to have all sources point to 1 directory, fun.dir.  
  ...
  loc <- paste(direct,"Data/Survey_data/2011/Spring/",sep="")
  
################# Middle #################################

  
  #Read1 Survey data for Middle bank in 2011
 tmp<-read.csv(paste(loc,"TE11Midhfchecked.csv",sep=""),stringsAsFactors = F)
...
################# Sable #################################
 ...
 tmp.1<-read.csv(paste(loc,"TE11Sabhf60checked.csv",sep=""),stringsAsFactors = F)
 #Read3
 tmp.2<-read.csv(paste(loc,"TE11Sabhf120checked.csv",sep=""),stringsAsFactors = F)
 #Read4
 tmp.3<-read.csv(paste(loc,"TE11Sabhf135checked.csv",sep=""),stringsAsFactors = F)
...
################# Browns North #################################
 ...
 tmp.1<-read.csv(paste(loc,"TE11BBnhf58checked.csv",sep=""),stringsAsFactors = F)
 #Read6
 tmp.2<-read.csv(paste(loc,"TE11BBnhf5970checked.csv",sep=""),stringsAsFactors = F)
...
################# Browns south #################################
 ...
 tmp<-read.csv(paste(loc,"TE11BBshf25checked.csv",sep=""),stringsAsFactors = F)
...
################# German #################################
 ...
 tmp.1<-read.csv(paste(loc,"TE11Gerhf60checked.csv",sep=""),stringsAsFactors = F)
 #Read9
 tmp.2<-read.csv(paste(loc,"TE11Gerhf90checked.csv",sep=""),stringsAsFactors = F)
...
################# Georges #################################
 ...
 tmp.1<-read.csv(paste(loc,"TE11GBhf.peanutchecked.csv",sep=""),stringsAsFactors = F)
 #Read11
 tmp.2<-read.csv(paste(loc,"TE11GBhf46.no.peanutchecked.csv",sep=""),stringsAsFactors = F)
...
TE11pos<-read.csv(paste(loc,"TE11positions.csv",sep=""),stringsAsFactors = F)
...
ger.dis<-with(gerDis[[1]],data.frame(bank='Ger',tow=tow,dis=dis,date=date,brg=brg))
sab.dis<-with(sabDis[[1]],data.frame(bank='Sab',tow=tow,dis=dis,date=date,brg=brg))
mid.dis<-with(midDis[[1]],data.frame(bank='Mid',tow=tow,dis=dis,date=date,brg=brg))
bbn.dis<-with(bbnDis[[1]],data.frame(bank='BBn',tow=tow,dis=dis,date=date,brg=brg))
bbs.dis<-with(bbsDis[[1]],data.frame(bank='BBs',tow=tow,dis=dis,date=date,brg=brg))
gb.dis<-with(gbDis[[1]],data.frame(bank='GB',tow=tow,dis=dis,date=date,brg=brg))
...
bbnTows<-read.csv(paste(loc,"BBNTows2011_ar.csv",sep=""),stringsAsFactors = F)
#Read14
bbsTows<-read.csv(paste(loc,"BBSTows2011_ar.csv",sep=""),stringsAsFactors = F)
#Read15
gerTows<-read.csv(paste(loc,"GerTows2011_ar.csv",sep=""),stringsAsFactors = F)
#Read16
sabTows<-read.csv(paste(loc,"SabTows2011_ar.csv",sep=""),stringsAsFactors = F)
...
# This converts the depths from fathoms to meters.
...
mw<-read.csv(paste(loc,"TE11SS11mtwt_no.check.csv",sep=""),stringsAsFactors = F)
