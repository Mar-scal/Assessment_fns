...
res <- survey.data(direct = direct,un.ID=un.ID,pwd.ID=pwd.ID,preprocessed=F,yr=2016,
            surveys =  c("BBsspring","BBnspring" ,"Gerspring", "Midspring", "Sabspring", "GBspring" ,"GBbsummer", "GBasummer"),
            db.con="ptran",season="both",survey.year = 2016)
...
#,"BBs", "Ger", "Mid", "Sab", "GB")
survey.figs(direct = direct,fig="file",season="both",yr=2016,banks = c("BBs"),plots="MW-SH")

survey.figs(direct = direct,fig="file",banks = c("Mid"),season="both",yr=2014)
