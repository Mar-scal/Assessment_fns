...
delayBUGS <- function(model, input, priors, years, n = 60000, burn = 20000, 
                      thin = 10, nchains = 2, debug = F, wd="",parameters=c(names(priors),'K','P','B','R','mu'),
	...
	require(R2WinBUGS)
		...
		#browser()
		## Call to WinBUGS ##
		tmp <- bugs(data = data, inits, parameters.to.save = parameters, model.file = paste(wd,model,".bug",sep=""), n.chains = nchains, n.iter = n, n.burnin = burn, n.thin = thin, bugs.directory = "C:/WinBUGS14/", debug = debug)
