...
for(j in 1:num.banks)
{
  ...
  #Read2 Get the managment data 
  cat(paste("NOTE!!! Please ensure the file Ref_pts_and_tac.csv is updated with the interim TAC or you won't have information for the", 
