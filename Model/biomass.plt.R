                        ...
                        language="en")
{
  ...
  if(missing(out.data2)==T)
  {
    ...
    if(kt==T & language=="fr")mtext("Fully-Recruited Biomass (kt)", 2, 3, cex=1.2)
    if(kt==F & language=="fr") mtext("Fully-Recruited Biomass (t)", 2, 3, cex=1.2)
  ...
  if(missing(out.data2)==F)
  {
    ...
    if(kt==T & language=="fr") mtext("Fully-Recruited Biomass (kt)", 2, -1, cex=1.2,outer=T)
    if(kt==F & language=="fr") mtext("Fully-Recruited Biomass (t)", 2, -1, cex=1.2,outer=T)
  ...
  if(missing(out.data2)==T)
  {
    # If the maximum for the Recruit time series y axis isn't specified than we find it using the alpha value.
  	...
  	if(kt==T)
  	{
  	  ...
  	  if(language=="fr") mtext("Recruit Biomass (kt)", 2, 3, cex=1.2)
  	}
  	...
  	if(kt==F)
  	{
  	  ...
  	  if(language=="fr") mtext("Recruit Biomass (t)", 2, 3, cex=1.2)
  	} #end if(kt==F)
