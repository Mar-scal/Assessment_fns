...
newpres <- read_pptx("Y:/Offshore/Assessment/2022/Presentations/Survey_summary/template.pptx")
...
overviewtable <- data.frame(Bank=c("Middle", "Banquereau", "Sable", "German", "Browns South", "Browns North", 
                            ...
                            `Last Survey`=c(2021, 2019, 2021, 2021, 2021, 2021, 2021, 2021, 2021), 
...
newpres <- newpres %>%
  ...
  ph_with(location = ph_location_label(ph_label = "Title 1"), value="Survey Summary 2022", index=1) %>%
...
for (i in 1:length(banks)) {
  ...
  newpres <- newpres %>%
    ...
    ph_with(external_img(paste0("Y:/Offshore/Assessment/2022/Presentations/Survey_summary/", banks[i],"/survey_strata.png")),
    ...
    ph_with(external_img(paste0("Y:/Offshore/Assessment/2022/Presentations/Survey_summary/", banks[i],"/abundance_ts.png")),
            location = ph_location_label(ph_label = "Picture Placeholder 2"), index=1) %>%
    ph_with(location = ph_location_label(ph_label = "Content Placeholder 19"), value=corner, index=1) %>%

    # slide 4
    add_slide(layout="Scallop Time Series Plot", master="Default Design") %>%
    ph_with(external_img(paste0("Y:/Offshore/Assessment/2022/Presentations/Survey_summary/", banks[i],"/biomass_ts.png")),
            location = ph_location_label(ph_label = "Picture Placeholder 2"), index=1) %>%
    ph_with(location = ph_location_label(ph_label = "Content Placeholder 19"), value=corner, index=1) %>%

    # slide 5
    add_slide(layout="Scallop SHF Plot", master="Default Design") %>%
    ph_with(external_img(paste0("Y:/Offshore/Assessment/2022/Presentations/Survey_summary/", banks[i],"/SHF.png")),
    ...
    ph_with(external_img(paste0("Y:/Offshore/Assessment/2022/Presentations/Survey_summary/", banks[i],"/MWSH_and_CF_ts_wide.png")),
    ...
    ph_with(external_img(paste0("Y:/Offshore/Assessment/2022/Presentations/Survey_summary/", banks[i],"/PR-spatial.png")),
            location = ph_location_label(ph_label = "Picture Placeholder 3"), index=1) %>%
    ph_with(location = ph_location_label(ph_label = "Content Placeholder 19"), value=corner, index=1) %>%

    # slide 7
    add_slide(layout="Scallop INLA map plot", master="Default Design") %>%
    ph_with(external_img(paste0("Y:/Offshore/Assessment/2022/Presentations/Survey_summary/", banks[i],"/Rec-spatial.png")),
            location = ph_location_label(ph_label = "Picture Placeholder 3"), index=1) %>%
    ph_with(location = ph_location_label(ph_label = "Content Placeholder 19"), value=corner, index=1) %>%

    # slide 8
    add_slide(layout="Scallop INLA map plot", master="Default Design") %>%
    ph_with(external_img(paste0("Y:/Offshore/Assessment/2022/Presentations/Survey_summary/", banks[i],"/FR-spatial.png")),
            location = ph_location_label(ph_label = "Picture Placeholder 3"), index=1) %>%
    ph_with(location = ph_location_label(ph_label = "Content Placeholder 19"), value=corner, index=1) %>%
    ...
    ph_with(external_img(paste0("Y:/Offshore/Assessment/2022/Presentations/Survey_summary/", banks[i],"/CF-spatial.png")),
            location = ph_location_label(ph_label = "Picture Placeholder 3"), index=1) %>%
    ph_with(location = ph_location_label(ph_label = "Content Placeholder 19"), value=corner, index=1) %>%
    ...
    ph_with(external_img(paste0("Y:/Offshore/Assessment/2022/Presentations/Survey_summary/", banks[i],"/MC-spatial.png")),
            location = ph_location_label(ph_label = "Picture Placeholder 3"), index=2) %>%
    ph_with(location = ph_location_label(ph_label = "Content Placeholder 19"), value=corner, index=1) %>%

    # slide 12
    add_slide(layout="Scallop Time Series Plot", master="Default Design") %>%
    ph_with(external_img(paste0("Y:/Offshore/Assessment/2022/Presentations/Survey_summary/", banks[i], "/Clapper_abund_ts.png")),
            location = ph_location_label(ph_label = "Picture Placeholder 2"), index=1) %>%
    ph_with(location = ph_location_label(ph_label = "Content Placeholder 19"), value=corner, index=1) %>%

    # slide 13
    add_slide(layout="Scallop Time Series Plot", master="Default Design") %>%
    ph_with(external_img(paste0("Y:/Offshore/Assessment/2022/Presentations/Survey_summary/", banks[i], "/Clapper_per_ts.png")),
            location = ph_location_label(ph_label = "Picture Placeholder 2"), index=1) %>%
    ph_with(location = ph_location_label(ph_label = "Content Placeholder 19"), value=corner, index=1) %>%
    ...
    ph_with(external_img(paste0("Y:/Offshore/Assessment/2022/Presentations/Survey_summary/", banks[i], "/breakdown-2022.png")),
