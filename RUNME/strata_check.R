...
planned <- readxl::read_excel("Y:/Offshore/Survey/SurveyWG/2021/Final_station_list_spring2021.xlsx", 
                              sheet = "Sable")
...
compare <- dplyr::select(planned, `Station#`, Strata_ID, Year, Bank) %>%
...
write.csv(strata_for_db, "Y:/Offshore/Assessment/Data/Survey_data/2021/Spring/strata_for_db.csv")
