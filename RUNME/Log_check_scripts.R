...
log_checks(direct = direct, direct_fns = direct_fns, yrs = 2020, marfis=F, repo = "local",
           #un="pearot",pw="RmGH79!y,db.con="ptran",db.lib = "RODBC",   #### Don't need this since marfis=F and repo="local"
           export = "fish.dat",
